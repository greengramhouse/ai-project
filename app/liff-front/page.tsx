      ...
      <main className="px-5 md:px-10 lg:px-20 pt-6 space-y-8 md:space-y-12 max-w-7xl mx-auto">
        ...
        <section>
          <div className="grid grid-cols-4 gap-4 md:gap-8">
            ...
            >
              <div className="w-14 h-14 md:w-20 md:h-20 bg-blue-100 text-blue-600 rounded-2xl md:rounded-3xl flex items-center justify-center text-2xl md:text-3xl mb-2 group-hover:-translate-y-1 group-active:scale-95 transition-all shadow-sm">
                📝
              </div>
              <span className="text-[11px] md:text-sm text-gray-600 dark:text-gray-300 font-medium text-center">
                ลงทะเบียน
              </span>
            </button>
            <button
              onClick={() => router.push("/liff-front/student-table")}
              className="flex flex-col items-center group"
            >
              <div className="w-14 h-14 md:w-20 md:h-20 bg-purple-100 text-purple-600 rounded-2xl md:rounded-3xl flex items-center justify-center text-2xl md:text-3xl mb-2 group-hover:-translate-y-1 group-active:scale-95 transition-all shadow-sm">
                📋
              </div>
              <span className="text-[11px] md:text-sm text-gray-600 dark:text-gray-300 font-medium text-center">
                รายชื่อนักเรียน
            ...
            <button
              onClick={() => router.push("/liff-front/doccheck")}
              className="flex flex-col items-center group"
            >
              <div className="w-14 h-14 md:w-20 md:h-20 bg-orange-100 text-orange-600 rounded-2xl md:rounded-3xl flex items-center justify-center text-2xl md:text-3xl mb-2 group-hover:-translate-y-1 group-active:scale-95 transition-all shadow-sm">
                📄
              </div>
              <span className="text-[11px] md:text-sm text-gray-600 dark:text-gray-300 font-medium text-center">
                เอกสาร
            ...
            <button
              ...
              className="flex flex-col items-center group"
            >
              <div className="w-14 h-14 md:w-20 md:h-20 bg-emerald-100 text-emerald-600 rounded-2xl md:rounded-3xl flex items-center justify-center text-2xl md:text-3xl mb-2 group-hover:-translate-y-1 group-active:scale-95 transition-all shadow-sm">
                ⚙️
              </div>
              <span className="text-[11px] md:text-sm text-gray-600 dark:text-gray-300 font-medium text-center">
                คุยกับธุรการ
        ...
        {/* 3. News & Announcements (เรียกใช้ NewsList แทน mockNews) */}
        <section>
          <div className="flex justify-between items-end mb-4">
            ...
            {isCheckingAuth ? (
              <button
                onClick={() => router.push("/liff-front/createnews")}
        ...
        <section>
          <div className="flex justify-between items-end mb-4">
            ...
            <button className="text-xs md:text-sm text-[#06C755] font-semibold hover:underline">
              แกลลอรี่
            </button>
          </div>
